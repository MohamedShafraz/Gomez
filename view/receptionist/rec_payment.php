...
{if(document.getElementsByClassName("navbar")[0].style.display=="none"){
    ...
    <a class="search">
        ...
        <tbody>
            <tr>
                ...
                <td>24/11/2023</td>
                <td>PAid</td>
                <td><a href="view_payment_details.php"><button class="" style="width:100%;border-radius: 6px;">View</button></a></td>
            </tr>
            <tr>
                <td>10522</td>
                <td>02</td>
    ...
    <a href="create_receipt"><button class="button">create receipt</button></a>
    </section>
</body>
</html>
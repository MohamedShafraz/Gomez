    ...
    <aside class="sidenav">
        ...
        <div class="sidenavbarspace">
                ...
                <a href="report.php" style="text-decoration: none;">
                    <div class="sidebarselected" id="unselect6">Reports<br></div></a>
...
{if(document.getElementsByClassName("navbar")[0].style.display=="none"){
    ...
    <h1>Hello Samar</h1>
    <br>
    <center><div class="titlebox"> Reports</div></center>
    <div class="d" style="margin-left: 10%;">
        ...
        <tbody>
            <tr>
                ...
                <td>004589</td>
                <td>Blood</td>
                <td><a href="L2.pdf"><button>download</button></a></td>
            ...
            <tr>
                ...
                <td>Xray</td>
                <td><a href="L2.pdf"><button>download</button></a></td>
                <td><a href="view_appointment_details.php"><button class="" style="width:100%;border-radius: 6px; ">Request</button></a></td>

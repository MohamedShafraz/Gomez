  ...
  padding-bottom: 4%;">no</button></div>
    ...
    <article class="dashboard">
        ...
        <ul style="background-color: white;padding:5%;width: 64%;">
            ...
            <a href="<?= URLROOT . "/receptionist/appointments/make" ?>"><button class="button" style="font-size: initial;height: max-content;width: max-content;margin-left: 81%;background-color: var(--Gomez-highlight);">Make appointment</button></a>
            </div>

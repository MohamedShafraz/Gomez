    ...
    <tbody class="complaint">
        ...
        <script>
            for (let index = 0; index < 8; index++) {
                document.writeln("<tr><td style='width: 120px;'>Saj</td><td style='width: 156px;'>200068300174</td><td style='width: 144px;'>0777124568</td><td><button class=test>view</button></td></tr><tr style='color:white;margin: 3%;'></tr>")
            }
        </script>

...
<style>
    ...
    margin: 1% 0% 0% 31%;
">
     <h1>Update Profile</h1><ul><li class="users">Full Name: Shaf<br><br></li></ul>  
     <button onclick="window.locaton.href -= '/'+$id.toString()" style="float:right" class="button">Edit</button>
</div>
<article class="dashboard">
    ...
    <div class="users" style="float: left;gap: 5%;width:50% ;"><img src="<?=URLROOT."/public/resources/user.jpeg"?>" alt="Profile Picture" style="width: 73%;"></div>   
        ...
        <button onclick="m()" style="float:right" class="button">Edit</button>
    </ul>
</div>
</article>
</body>

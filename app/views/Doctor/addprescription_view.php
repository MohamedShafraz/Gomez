...
<article class="dashboard">
    <div style="margin-left:24%; display:flex; justify-content:center;">
        ...
        <form id="labForm" class="card" onsubmit="submitForm()" action="<?= URLROOT . "/Doctor/AddPrescription" ?>" method="post" style="margin-top:5%;">
            ...
            <input type="hidden" name="patient_id" value="<?php echo $appointment[0]['Patient_Id'] ?>" require>

            <label for="disease">Disease</label><br>
            <textarea id="disease" name="disease" rows="4" cols="50" require></textarea><br><br>

            <label for="prescription">Instructions</label><br>
            <textarea id="prescription" name="prescription" rows="4" cols="50" require></textarea><br><br>
            ...
            <div style="display:flex;flex-direction:row;">
                <select id="labtestinglist" name="labtesting" require>
            ...
            <input type="hidden" id="priscription_date" name="priscription_date" value="<?= date('Y-m-d'); ?>" require>

        ...
        <?php
            ...
            if (empty($prescriptions)) {
                ...
                foreach ($prescriptions as $prescription) {
                    ...
                    echo '<td><button class="orangebutton" onclick="window.location.href=\''.URLROOT.'/DoctorController/ViewMorePrescription/'.$prescription["prescription_id"]."/".$prescription["Appointment_id"].'\'" >View</button></td>';              
                    echo "</tr>";
                }
                echo "</table>";
            }

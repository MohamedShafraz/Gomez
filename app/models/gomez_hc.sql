...
CREATE TABLE IF NOT EXISTS `appointment` (
  ...
  KEY `doctor_ibfk_3` (`doctor_id`),
  KEY `patient_ibfk_4` (`Patient_ID`)
...
ALTER TABLE `appointment`
  ...
  ADD CONSTRAINT `doctor_ibfk_3` FOREIGN KEY (`doctor_id`) REFERENCES `doctors` (`Doctor_id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  ADD CONSTRAINT `patient_ibfk_3` FOREIGN KEY (`Patient_ID`) REFERENCES `patients` (`ID`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  ADD CONSTRAINT `patient_ibfk_4` FOREIGN KEY (`Patient_ID`) REFERENCES `patients` (`ID`) ON DELETE RESTRICT ON UPDATE RESTRICT;

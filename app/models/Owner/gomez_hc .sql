...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Apr 18, 2024 at 02:03 PM
...
CREATE TABLE IF NOT EXISTS `report_mst` (
  ...
  `PATIENT_MOBILENO` varchar(10) DEFAULT NULL,
  `TEST_NAME` text,
  PRIMARY KEY (`REF_NO`)
...
INSERT INTO `report_mst` (`REF_NO`, `PATIENT_ID`, `PATIENT_NAME`, `PATIENT_MOBILENO`, `TEST_NAME`) VALUES
(1, '124500', 'JOHN PERERA', '9825121212', 'F.B.C'),
(2, '124590', 'NIMALI SILVA', '8457878878', 'LIPID PROFILE'),
(3, '124599', 'STEVEN LEWIS', '7487878788', 'URINAlYSIS');

...
INSERT INTO `lab_assistants` (`id`, `fullname`, `gender`, `email`, `NIC`, `phonenumber`, `Username`) VALUES
(6, 'Bhagya', 'Female', 'Bhag@live.com', 200187500274, 755123456, 'Bhag');
...
INSERT INTO `report` (`refno`, `passcode`, `status`, `testname`, `patient_id`, `filename`) VALUES
(1, 25002, 'pending', 'FBS', 1245001, NULL),
(2, 25004, 'Complete', 'Lipid', 124506, NULL);

-- --------------------------------------------------------

--
-- Table structure for table `report_det`
--

DROP TABLE IF EXISTS `report_det`;
CREATE TABLE IF NOT EXISTS `report_det` (
  `DET_ID` int NOT NULL AUTO_INCREMENT,
  `REF_NO` int DEFAULT NULL,
  `INVESTIGATION` varchar(255) DEFAULT NULL,
  `RESULT` double(11,2) DEFAULT NULL,
  `REF_VALUE` double(11,2) DEFAULT NULL,
  `UNIT` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`DET_ID`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=latin1;

--
-- Dumping data for table `report_det`
--

INSERT INTO `report_det` (`DET_ID`, `REF_NO`, `INVESTIGATION`, `RESULT`, `REF_VALUE`, `UNIT`) VALUES
(1, 1, 'HEMOGLOBIN', 12.50, 13.00, 'g/dL'),
(2, 1, 'RBC COUNT', 5.20, 4.50, 'ml/cumm'),
(3, 1, 'PLATELET COUNT', 150000.00, 150000.00, 'cumm'),
(4, 2, 'TOTAL CHOLESTEROL', 210.00, 125.00, 'mg/dL'),
(5, 2, 'LDL CHOLESTEROL', 150.00, 70.00, 'mg/dL'),
(6, 3, 'PROTIEN', 30.00, 100.00, 'mg/dL');

-- --------------------------------------------------------

--
-- Table structure for table `report_mst`
--

DROP TABLE IF EXISTS `report_mst`;
CREATE TABLE IF NOT EXISTS `report_mst` (
...
--
-- Dumping data for table `report_mst`
--

INSERT INTO `report_mst` (`REF_NO`, `PATIENT_ID`, `PATIENT_NAME`, `TEST_NAME`) VALUES
(1, '124500', 'JOHN PERERA', 'F.B.C'),
(2, '124590', 'NIMALI SILVA', 'LIPID PROFILE'),
(3, '124599', 'STEVEN LEWIS', 'URINAlYSIS');
...
(6, '09a8198091045ee1cde7ba7237cd175e', 'Bhag@live.com', 'LabAssistant', 'Bhag', ''),
